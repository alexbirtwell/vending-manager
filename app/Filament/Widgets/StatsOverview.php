...
class StatsOverview extends BaseWidget
{
    protected function getStats(): array
    {
         return [
            ...
            Stat::make('Income This Month', config('business.currency.symbol') . number_format(IncomeLog::where('created_at', '>=', now()->startOfMonth())->sum('amount'),config('business.currency.decimals')))
            ...
            Stat::make('Expenses This Month', config('business.currency.symbol') . number_format(MachineExpense::where('created_at', '>=', now()->startOfMonth())->sum('amount'),config('business.currency.decimals')))
